<script lang="ts">
  ...
  import { PUBLIC_DEMO_MODE, PUBLIC_GOOGLE_AUTH_ENABLED } from '$env/static/public'
...
<svelte:head>
  <title>Ensaluti — Verdkomunumo</title>
</svelte:head>
...
<form method="POST" action="?/login" use:enhance={withPendingAction(() => {
  loading = true
  ...
  <button class="btn-primary" type="submit" disabled={loading}>
    {loading ? 'Atendu…' : 'Ensaluti'}
  </button>
</form>

<p class="auth-footer">
  Ankoraŭ ne havas konton? <a href="/register">Registriĝi</a>
</p>
