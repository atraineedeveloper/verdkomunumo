...
const features = [
  ...
  },
  {
    ...
    color: '#3b82f6',
    title: 'Kategorioj',
    description: 'Kulturo, lernado, vojaĝoj, teknologio, kaj pli.',
  },
  {
    icon: Sprout,
    color: '#16a34a',
    title: 'Por ĉiuj niveloj',
    description: 'Komencanto, progresanto aŭ flua - ĉiuj estas bonvenaj.',
  },
] as const
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="La socia reto por esperantistoj. Konektiĝu, legu, skribu kaj praktiku Esperanton."
        />
      </Helmet>
